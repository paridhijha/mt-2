        ...
        if f[i:j] in tm:
          for phrase in tm[f[i:j]]:
            ...
            if h2 and h1.swapped == 'false':
              ...
              alt_i = i - len(h1.phrase[0].split(' '))
              if  alt_i >= 0 and (lm_state not in stacks[j] or stacks[j][lm_state].logprob < logprob):
                ...
                # only below 2 lines added
                #alt_i = i - len(h1.phrase[0].split(' ')) #+ len(h0.phrase[0].split(' '))
                #if alt_h1.lm_state not in stacks[alt_i] or stacks[alt_i][alt_h1.lm_state].logprob < alt_h1.logprob:
                  #print "wohooo", alt_i
                #stacks[alt_i][alt_h1.lm_state] = alt_h1
